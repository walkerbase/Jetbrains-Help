...
OS_NAME=$(uname -s)
JB_PRODUCTS="appcode aqua clion datagrip dataspell devecostudio gateway goland idea jetbrains_client jetbrainsclient phpstorm pycharm rider rubymine rustrover studio webide webstorm"
